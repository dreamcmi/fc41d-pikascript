...
#define SPI_USE_LINE         SPI_USE_4_LINE         /* default:4 line mode*/

#if  CFG_SUPPORT_SPI_FLASH_TEST
#define SPI_LINE_MODE			SPI_USE_3_LINE		/* spi flash default:3 line mode*/
#else
#define SPI_LINE_MODE			SPI_USE_LINE		/* default:4 line mode*/
#endif
...
void bk_spi_master_dma_transfer_3line(struct spi_message *spi_msg);
