...
const UINT16 hm_1055_init_talbe[][2] =
{
    {0x0022, 0x00},//	; RESET
    ...
    {0x0025, 0x01},//	; PLL on	//chen 0x00
    {0x0020, 0x00},//	;
    {0x0027, 0x30},//	; FPGA 24
    {0x0028, 0xC0},//	;
    {0x0004, 0x10},//	;
    {0x0006, 0x10},//	; Modified by Brandon. No Flip
    {0x0012, 0x0F},//	;
    {0x0044, 0x04},//	;
    {0x004A, 0x2A},//	;
    {0x004B, 0x72},//	;
    ...
    {0x0121, 0x80},//
    {0x0122, 0x6B},//	; 122[3] is temperature_control_bit2
    ...
    {0xAFD7, 0x44},//	;
    {0xAFD8, 0x02},//	;
    {0x0B02, 0x05},//	; TLPX Width
    {0x0B03, 0x08},//	; HS ZERO WIDTH
    {0x0B04, 0x05},//	; HS TRAIL WIDTH
    {0x0B05, 0x15},//  ; CLK ZERO WIDTH
    {0x0B06, 0x05},//	; CLK TRIAL WIDTH
    {0x0B07, 0x28},//	; MARK1 WIDTH
    {0x0B0E, 0x1E},// ; CLK FRONT PORCH WIDTH
    {0x0B0F, 0x09},// ; CLK BACK PORCH WIDTH
    {0x0B11, 0x7F},// ; Clock Lane LP Driving Strength
    {0x0B12, 0x7F},// ; Data Lane LP Driving Strength
    {0x0B17, 0xE0},// ; D-PHY Power Down Control
    {0x0B20, 0x9E},//	; Set clock lane always on
    ...
    {0x0B36, 0x02},// ; Data Lane WIDTH for HS to LP(HS-Trail)
    {0x0B37, 0x00},// ; Clock Lane WIDTH for LP to HS(LP-00)
    {0x0B38, 0x02},// ; Clock Lane WIDTH for HS to LP(HS-Trail)
    {0x0B39, 0x0F},// ; Clock Lane HS_EXIT WIDTH(at least 100ns)
    {0x0B3A, 0x00},// ; Data Lane HS_EXIT WIDTH(at least 100ns)
    {0x0B3B, 0x33},// ; MIPI3, [1:0]: HS Slew Control ; [3]: 0: New D-PHY ; 1: Old D-PHY
    {0x0024, 0x00},// ; [6]: MIPI Enable //chen 0x40
    {0x000F, 0x00},// ; //chen bit[4]: Fixed row length
    #if 0
    {0x0006, 0x00},// ; 1280*720
    {0x05E4, 0x08},// ; 1280*720
    {0x05E5, 0x00},// ; 1280*720
    {0x05E6, 0x07},// ; 1280*720
    {0x05E7, 0x05},// ; 1280*720
    {0x05E8, 0x06},// ; 1280*720
    {0x05E9, 0x00},// ; 1280*720
    {0x05EA, 0x25},// ; 1280*720
    {0x05EB, 0x03},// ; 1280*720
    #else
    {0x0006, 0x10},  // those for 640*480
    {0x000D, 0x00},
    {0x000E, 0x00},
