...
#if (APP_DEMO_VIDEO_TRANSFER == 1) && (APP_VIDEO_TRANSFER_MODE & VIDEO_TRANSFER_P2P_MODE)
#include "common.h"
#include "uart_pub.h"
#include "mem_pub.h"
...
#endif  // (APP_DEMO_VIDEO_TRANSFER == 1) && (APP_VIDEO_TRANSFER_MODE & VIDEO_TRANSFER_P2P_MODE)
